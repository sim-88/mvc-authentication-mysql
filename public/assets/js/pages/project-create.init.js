                        ...
                        return (
                            "add" == g
                                ? (null != sessionStorage.getItem("inputValue")
                                      ? ((l = JSON.parse(sessionStorage.getItem("inputValue"))), (u = { id: t + 1, projectLogoImg: n, projectTitle: a, projectDesc: o, dueDate: i, status: r, assignedto: s }), l.push(u))
                                      : (l = []).push((u = { id: t, projectLogoImg: n, projectTitle: a, projectDesc: o, dueDate: i, status: r, assignedto: s })),
                                ...
                                ? ((d = document.getElementById("project-id-input").value),
                                  sessionStorage.getItem("editInputValue") &&
                                      ((m = { id: parseInt(d), projectLogoImg: n, projectTitle: a, projectDesc: o, dueDate: i, status: r, assignedto: s }), sessionStorage.setItem("editInputValue", JSON.stringify(m))))
    ...
    Array.from(document.querySelectorAll("#select-element .assignto-list li a")).forEach(function (i) {
        i.addEventListener("click", function () {
            ...
            i.classList.contains("active")
                ...
                : Array.from(r.querySelectorAll(".avatar-group-item")).forEach(function (e) {
