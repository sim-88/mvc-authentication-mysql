...
//                         }),
//                         2 < n.length && ((i = n.length - 2), (s += '<a href="javascript: void(0);" class="badge badge-soft-primary font-size-11 m-1">' + i + " more</a>")),
//                         s
//                     );
//                 },
//             },
...
//                             (document.getElementById("designation-input").value = e.designation),
...
//                   (a = "assets/images/users/user-dummy-img.jpg" == t.substring(t.indexOf("/as") + 1) ? "" : t),
...
//                         (userListData = userListData.map(function (e) {
//                             return e.id != l ? e : { id: l, memberImg: a, nickname: n, userName: i, designation: s, email: r, tags: d, projects: e.projects };
//                         })),
//                         (editList = !1))
//                       : ((o = { id: findNextId(), memberImg: a, nickname: n, userName: i, designation: s, email: r, tags: d, projects: "--" }), userListData.push(o)),
//                   $.fn.DataTable.isDataTable("#userList-table") && $("#userList-table").DataTable().destroy(),
...
// public/js/contact-user-list.init.js
$(document).ready(function() {
    const table = $('#userList-table').DataTable({
        ajax: {
            url: 'http://localhost:3000/api/team/3', // Fetch data from this URL
            dataSrc: ''
        },
        columns: [
            { data: 'user_id' },
